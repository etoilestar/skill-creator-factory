...
from .routers import chat, creator, creator_chat, creator_tools, health, sandbox_chat, skills, skills_chat, publish, publish_gateway, skill_refine
...
app.include_router(skill_refine.router)
