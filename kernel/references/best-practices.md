...
- **无障碍的开阔田野**：多条路径都能成功 → 给出大方向，信任模型找到最佳路线（高自由度）
...
1. **识别差距**: 在没有 Skill 的情况下让模型执行代表性任务，记录具体失败
2. **设计测试提问**: 构建三个测试这些差距的提问
3. **建立基线**: 观察没有 Skill 时模型的表现
